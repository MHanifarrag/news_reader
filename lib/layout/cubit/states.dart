...
class NewsGetSavedSuccessState extends NewsStates {}
class NewsGetSavedLoadingState extends NewsStates {}
class NewsGetSavedErrorState extends NewsStates
{
  final String error;
  NewsGetSavedErrorState(this.error);
}
...
abstract class ClipStates {}
class ClipInitialState extends ClipStates {}
class ClipSelectedState extends ClipStates {}